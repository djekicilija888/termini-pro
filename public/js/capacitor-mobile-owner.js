...
/* v193 - Android Profil firme scroll fix.
   Ovaj stil se dodaje posle svih forsiranih mobilnih stilova, zato pregazi stare padding/overflow vrednosti. */
;(()=>{try{
  if(document.getElementById('cap-profile-scroll-fix-v193'))return;
  const s=document.createElement('style');
  s.id='cap-profile-scroll-fix-v193';
  s.textContent=`
@media (max-width: 820px){
  html,
  html body.cap-mobile-owner-ready:not(.owner-booting){
  ...
  html body.cap-mobile-owner-ready #settingsForm{
    height:auto !important;
    min-height:auto !important;
    max-height:none !important;
    overflow:visible !important;
  ...
  html body.cap-mobile-owner-ready #settingsForm > button[type="submit"],
  html body.cap-mobile-owner-ready #settingsForm > .btn:last-child{
