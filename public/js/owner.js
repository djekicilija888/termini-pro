...
const emailLines=splitWords(emailText,24,2);
    ...
    for(let r=0;r<rows;r++){
      for(let c=0;c<cols;c++){
        ...
        centeredText(qrCenterX,y+18,11.2,true,'ZAKAZITE TERMIN');
        centeredText(qrCenterX,y+31,11.2,true,'ONLINE');
        ...
        emailLines.forEach((ln,idx)=>centeredText(qrCenterX,y+145+idx*8,8.2,false,ln));
      }
    }
